...
<template>
    <Link class="border text-gray-800 p-2 flex space-x-3 hover:bg-gray-200" :href="route('project.show', project)">
        ...
        <div>
            <p class="font-bold" v-text="project.name"></p>
            <p class="text-xs font-semibold" v-text="project.contact.name"/>
