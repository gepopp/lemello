...
<template>
    <div class="flex justify-between border border-gray-400 p-2">
        <div class="flex space-x-3 items-center w-1/3">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <div>
            <p v-text="formatDateTime(timetrack.created_at, 'DD.MM.YY')"/>
        ...
        <div class="whitespace-pre w-1/3">{{ timetrack.note }}</div>
    </div>
</template>
