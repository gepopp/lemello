...
const form = useForm({
    ...
    contact_id: props.project.contact.id
});
...
<template>
    <AppLayout :title="__('Edit Project')">
        <template #header>
        ...
        <form @submit.prevent="submit">
            ...
            <ContactSelect v-on:set="company => form.contact_id = company.id" v-on:remove="form.contact_id = null" :contact="project.contact"/>
