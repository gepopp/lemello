    ...
    <AppLayout :title="__('New Contact')">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-10">
                <div>
                    <div class="my-2">
                        <JetLabel :for="company">{{ __('Please Choose') }}</JetLabel>
                        <div class="mt-1 flex w-full">
                            <div class="selectbox" :class="company ? '': 'active'" v-on:click="company = false">
                                {{ __('Person') }}
                            </div>
                            <div class="selectbox" :class="company ? 'active': ''" v-on:click="company = true">
                                {{ __('Company') }}
                            </div>
                        </div>
                    </div>
